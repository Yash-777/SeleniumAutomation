...
import com.github.server.file.GeckoDriver;
...
public class Selenium_3 {
	public static void main(String[] args) throws IOException {
		...
		String binaryPath = "D:\\BrowsersCustomInstalation\\FF55\\firefox.exe";
		...
		if( firefoxVersion != null  && !"".equalsIgnoreCase( firefoxVersion ) && browserName.contains("firefox")
			...
			if ( parseInt <= 47 ) {
				...
				String driver = GeckoDriver.getDriver(FF_DriverPack);
